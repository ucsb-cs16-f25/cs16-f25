...
* <https://ucsb.instructure.com/courses/19503/files/2663999>
...
* Then, in the same browser window, navigate to <https://github.com/ucsb-cs16-s24>.   Then go to the tab that says `People`, and under that tab, search for your own name (or GitHub id).  You should be able to see the members of the organization, and your name should appear in that list.
  * If you are not able to see the `People` tab, or your name does not appear in the list, look at the top of the page for <https://github.com/ucsb-cs16-s24> and see if you find an invitation to the organization that you haven't accepted yet.  If that appears, please click to accept the invitation to the organization.  After doing this, one of the staff will need to create your gsa01 repository, so ask for assistance.
...
Next, open a web browser to <https://github.com/ucsb-cs16-s24> and if you are not already logged in, login to GitHub.
...
* <https://github.com/ucsb-cs16-s24/gsa01-cgaucho>
...
|----------------------------|------------------------------------|-----------------------|
| `HTTPS` | `https://github.com/ucsb-cs16-s24/gsa01-AvishekDe.git` | <span>NOT this</span>{: .label .label-red } | 
| `SSH`   |  `git@github.com:ucsb-cs16-s24/gsa01-AvishekDe.git` | <span>THIS</span>{: .label .label-green }  |
...
```
$ git clone git@github.com:ucsb-cs16-s24/gsa01-YOUR-GITHUB-USERNAME.git
```
...
```
[pconrad@csilvm-03 cs16]$ git clone git@github.com:ucsb-cs16-s24/gsa01-YOUR-GITHUB-ID
...
* <https://github.com/ucsb-cs16-s24/gsa01-YOUR-GITHUB-USERNAME>
